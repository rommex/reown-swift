...
class NotificationService: UNNotificationServiceExtension {
    ...
    private func handleWalletKitNotification(content: UNNotificationContent, topic: String, tag: UInt, ciphertext: String) -> UNMutableNotificationContent {
        ...
        do {
            let WalletKitDecryptionService = try WalletKitDecryptionService(groupIdentifier: "group.com.unstoppabledomains.reown.example")
    ...
    private func handleNotifyNotification(content: UNNotificationContent, topic: String, ciphertext: String) -> UNMutableNotificationContent {
        do {
            let service = NotifyDecryptionService(groupIdentifier: "group.com.unstoppabledomains.reown.example")
...
private extension NotificationService {
    ...
    func log(_ event: String, account: Account? = nil, topic: String? = nil, message: NotifyMessage? = nil) {
        let keychain = GroupKeychainStorage(serviceIdentifier: "group.com.unstoppabledomains.reown.example")
